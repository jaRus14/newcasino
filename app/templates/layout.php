...
<div class="container">
  <!-- Content here -->
  <img src="../web/img/imagenesHome/casin.jpg" class="size img-fluid" alt="Responsive image">
  ...
  <div class="collapse navbar-collapse" id="navbarText">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="index.php?ctl=blackjack">BlackJack</a>
      </li>
...
<!-- Footer -->
  ...
  <div class=" pie footer-copyright text-center py-3">
